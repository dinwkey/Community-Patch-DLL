...
int CvLuaEnums::pRegister(lua_State* L)
{
	...
	RegisterEnum(TASK_UNSLOT_SPECIALIST);
	...
	RegisterEnum(DIPLO_UI_STATE_PLUNDERED_TRADE_ROUTE);
	...
	RegisterEnum(FROM_UI_DIPLO_EVENT_HUMAN_DISCUSSION_STOP_PLUNDERING);
	RegisterEnum(FROM_UI_DIPLO_EVENT_PLUNDERED_TRADE_ROUTE_RESPONSE);

	RegisterEnum(FROM_UI_DIPLO_EVENT_HUMAN_DISCUSSION_SHARE_APPROACH);
	...
	RegisterEnum(INSTANT_YIELD_TYPE_BIRTH);
	RegisterEnum(INSTANT_YIELD_TYPE_DEATH);
	RegisterEnum(INSTANT_YIELD_TYPE_PROPOSAL);
	RegisterEnum(INSTANT_YIELD_TYPE_ERA_UNLOCK);
	RegisterEnum(INSTANT_YIELD_TYPE_POLICY_UNLOCK);
	RegisterEnum(INSTANT_YIELD_TYPE_INSTANT);
	RegisterEnum(INSTANT_YIELD_TYPE_TECH);
	RegisterEnum(INSTANT_YIELD_TYPE_CONSTRUCTION);
	RegisterEnum(INSTANT_YIELD_TYPE_BORDERS);
	RegisterEnum(INSTANT_YIELD_TYPE_GP_USE);
	RegisterEnum(INSTANT_YIELD_TYPE_GP_BORN);
	RegisterEnum(INSTANT_YIELD_TYPE_F_SPREAD);
	RegisterEnum(INSTANT_YIELD_TYPE_F_CONQUEST);
	RegisterEnum(INSTANT_YIELD_TYPE_VICTORY);
	RegisterEnum(INSTANT_YIELD_TYPE_U_PROD);
	RegisterEnum(INSTANT_YIELD_TYPE_PURCHASE);
	RegisterEnum(INSTANT_YIELD_TYPE_TILE_PURCHASE);
	RegisterEnum(INSTANT_YIELD_TYPE_FOUND);
	RegisterEnum(INSTANT_YIELD_TYPE_TR_END);
	RegisterEnum(INSTANT_YIELD_TYPE_CONVERSION);
	RegisterEnum(INSTANT_YIELD_TYPE_SPREAD);
	RegisterEnum(INSTANT_YIELD_TYPE_BULLY);
	RegisterEnum(INSTANT_YIELD_TYPE_TR_MOVEMENT);
	RegisterEnum(INSTANT_YIELD_TYPE_SCOUTING);
	RegisterEnum(INSTANT_YIELD_TYPE_LEVEL_UP);
	RegisterEnum(INSTANT_YIELD_TYPE_PILLAGE);
	RegisterEnum(INSTANT_YIELD_TYPE_BIRTH_RETROACTIVE);
	RegisterEnum(INSTANT_YIELD_TYPE_SPY_ATTACK);
	RegisterEnum(INSTANT_YIELD_TYPE_SPY_DEFENSE);
	RegisterEnum(INSTANT_YIELD_TYPE_DELEGATES);
	RegisterEnum(INSTANT_YIELD_TYPE_CONSTRUCTION_WONDER);
	RegisterEnum(INSTANT_YIELD_TYPE_MINOR_QUEST_REWARD);
	RegisterEnum(INSTANT_YIELD_TYPE_CULTURE_BOMB);
	RegisterEnum(INSTANT_YIELD_TYPE_REMOVE_HERESY);
	RegisterEnum(INSTANT_YIELD_TYPE_FAITH_PURCHASE);
	RegisterEnum(INSTANT_YIELD_TYPE_VICTORY_GLOBAL);
	RegisterEnum(INSTANT_YIELD_TYPE_PILLAGE_GLOBAL);
	RegisterEnum(INSTANT_YIELD_TYPE_CONVERSION_EXPO);
	RegisterEnum(INSTANT_YIELD_TYPE_PROMOTION_OBTAINED);
	RegisterEnum(INSTANT_YIELD_TYPE_BARBARIAN_CAMP_CLEARED);
	RegisterEnum(INSTANT_YIELD_TYPE_TR_PRODUCTION_SIPHON);
	...
	RegisterEnum(MINOR_CIV_QUEST_CONTEST_ARTSY_UNITS);
	RegisterEnum(MINOR_CIV_QUEST_CONTEST_SCIENCEY_UNITS);
	...
	RegisterEnum(MINOR_CIV_QUEST_EXPLORE_AREA);
	RegisterEnum(MINOR_CIV_QUEST_BUILD_X_BUILDINGS);
	RegisterEnum(MINOR_CIV_QUEST_SPY_MISSION);
	RegisterEnum(MINOR_CIV_QUEST_SPY_ON_MAJOR);
	RegisterEnum(MINOR_CIV_QUEST_COUP);
	RegisterEnum(MINOR_CIV_QUEST_ACQUIRE_CITY);
