...
public:
	...
	GD_INT_MEMBER(SQLITE_LOGGING_BATCHED_BUFFER_ROWS_MAX);
	...
	GD_INT_MEMBER(NUM_CITIES_COST_MOD_SCALING); //VP
	...
	GD_INT_MEMBER(VASSALAGE_CAPITULATION_BASE_THRESHOLD); // VP
	GD_INT_MEMBER(VASSALAGE_VOLUNTARY_BASE_THRESHOLD); // VP
	GD_INT_MEMBER(VASSALAGE_LIBERATION_BASE_THRESHOLD); // VP
	GD_INT_MEMBER(VASSALAGE_INDEPENDENCE_BASE_THRESHOLD); // VP
