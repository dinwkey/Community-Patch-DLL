...
public:
	enum SaveVersionTags
	{
		...
		SAVE_VERSION_LEAGUE_TARGET_CITY_STATE_RESTORE = 4,
		SAVE_VERSION_GRAND_STRATEGY_PRIORITY_COUNT = 5,
		SAVE_VERSION_DIPLOMACY_MEMORY = 6,
		SAVE_VERSION_DIPLOMACY_NO_PLUNDER_PROMISE = 7,
		SAVE_VERSION_LATEST = SAVE_VERSION_DIPLOMACY_NO_PLUNDER_PROMISE,
	};
	...
	int getNumSpyPassiveBonusInfos();
	std::vector<CvSpyPassiveBonusEntry*>& getSpyPassiveBonusInfo();
	_Ret_maybenull_ CvSpyPassiveBonusEntry* getSpyPassiveBonusInfo(SpyPassiveBonusTypes eSpyPassiveBonusNum);
	CvSpyPassiveBonusXMLEntries* GetGameSpyPassiveBonuses() const;

	int getNumSpyPassiveBonusDiplomatInfos();
	std::vector<CvSpyPassiveBonusDiplomatEntry*>& getSpyPassiveBonusDiplomatInfo();
	_Ret_maybenull_ CvSpyPassiveBonusDiplomatEntry* getSpyPassiveBonusDiplomatInfo(SpyPassiveBonusDiplomatTypes eSpyPassiveBonusDiplomatNum);
	CvSpyPassiveBonusDiplomatXMLEntries* GetGameSpyPassiveBonusesDiplomat() const;
	...
	GD_INT_MEMBER(EVENT_PROBABILITY_EACH_TURN); // VP
	GD_INT_MEMBER(CITY_EVENT_PROBABILITY_EACH_TURN); // VP
	...
	GD_INT_MEMBER(AI_CITIZEN_VALUE_FOOD_NEED_GROWTH);
	GD_INT_MEMBER(AI_CITIZEN_VALUE_FOOD_STARVING);
	...
	GD_INT_MEMBER(AI_CITIZEN_VALUE_GPP); // VP
	GD_INT_MEMBER(AI_NUM_CORE_CITIES_FOR_SPACESHIP); // VP
	...
	GD_INT_MEMBER(MINOR_BULLY_GOLD_GROWTH_FACTOR); // VP
	GD_INT_MEMBER(MINOR_CIV_GOLD_TRIBUTE_THRESHOLD); // VP
	GD_INT_MEMBER(MINOR_CIV_HEAVY_TRIBUTE_THRESHOLD); // VP
	...
	GD_INT_MEMBER(UPGRADE_EXTRA_TURNS_UNIT_SPAWN); // VP
	...
	GD_INT_MEMBER(MINOR_REMOVE_SPHERE_FRIENDSHIP); // VP
	GD_INT_MEMBER(MINOR_LIBERATION_RESTING_INFLUENCE); // VP
	GD_INT_MEMBER(MINOR_LANDMARK_RESTING_INFLUENCE); // VP
	...
	GD_INT_MEMBER(MINOR_CIV_QUEST_ROUTE_MAXIMUM_DISTANCE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CAMP_RANGE);
	GD_INT_MEMBER(MINOR_CIV_QUEST_WONDER_COMPLETION_MAX_TURNS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WONDER_COMPLETION_THRESHOLD);
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_MIN_DISTANCE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ARCHAEOLOGY_RANGE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ACQUIRE_CITY_MINIMUM_POP); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ACQUIRE_CITY_MINIMUM_TURNS); // VP
	...
	GD_INT_MEMBER(QUEST_DISABLED_KILL_CITY_STATE_FRIENDLY); // VP
	...
	GD_INT_MEMBER(QUEST_DISABLED_FIND_CITY); // VP
	GD_INT_MEMBER(QUEST_DISABLED_WAR); // VP
	GD_INT_MEMBER(QUEST_DISABLED_CONSTRUCT_NATIONAL_WONDER); // VP
	GD_INT_MEMBER(QUEST_DISABLED_GIFT_SPECIFIC_UNIT); // VP
	GD_INT_MEMBER(QUEST_DISABLED_FIND_CITY_STATE); // VP
	GD_INT_MEMBER(QUEST_DISABLED_INFLUENCE); // VP
	GD_INT_MEMBER(QUEST_DISABLED_CONTEST_TOURISM); // VP
	...
	GD_INT_MEMBER(QUEST_DISABLED_EXPLORE_AREA); // VP
	GD_INT_MEMBER(QUEST_DISABLED_BUILD_X_BUILDINGS); // VP
	GD_INT_MEMBER(QUEST_DISABLED_SPY_ON_MAJOR); // VP
	GD_INT_MEMBER(QUEST_DISABLED_COUP); // VP
	GD_INT_MEMBER(QUEST_DISABLED_ACQUIRE_CITY); // VP
	GD_INT_MEMBER(QUEST_DISABLED_ACQUIRE_CITY_MILITARISTIC_ONLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ROUTE_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ROUTE_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ROUTE_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ROUTE_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ROUTE_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ROUTE_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ROUTE_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ROUTE_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ROUTE_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ROUTE_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONNECT_RESOURCE_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONNECT_RESOURCE_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONNECT_RESOURCE_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONNECT_RESOURCE_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONNECT_RESOURCE_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONNECT_RESOURCE_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONNECT_RESOURCE_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONNECT_RESOURCE_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONNECT_RESOURCE_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONNECT_RESOURCE_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONNECT_RESOURCE_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_WONDER_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_WONDER_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_WONDER_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_WONDER_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_WONDER_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_WONDER_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_WONDER_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_WONDER_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_WONDER_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_WONDER_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_WONDER_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GREAT_PERSON_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GREAT_PERSON_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GREAT_PERSON_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GREAT_PERSON_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GREAT_PERSON_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GREAT_PERSON_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GREAT_PERSON_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GREAT_PERSON_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GREAT_PERSON_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GREAT_PERSON_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GREAT_PERSON_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_PLAYER_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_PLAYER_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_PLAYER_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_PLAYER_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_PLAYER_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_PLAYER_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_PLAYER_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_PLAYER_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_PLAYER_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_PLAYER_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_NATURAL_WONDER_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_NATURAL_WONDER_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_NATURAL_WONDER_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_NATURAL_WONDER_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_NATURAL_WONDER_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_NATURAL_WONDER_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_NATURAL_WONDER_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_NATURAL_WONDER_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_NATURAL_WONDER_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_NATURAL_WONDER_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIVE_GOLD_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIVE_GOLD_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIVE_GOLD_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIVE_GOLD_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIVE_GOLD_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIVE_GOLD_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIVE_GOLD_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIVE_GOLD_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIVE_GOLD_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIVE_GOLD_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_PLEDGE_TO_PROTECT_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_PLEDGE_TO_PROTECT_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_PLEDGE_TO_PROTECT_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_PLEDGE_TO_PROTECT_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_PLEDGE_TO_PROTECT_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_PLEDGE_TO_PROTECT_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_PLEDGE_TO_PROTECT_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_PLEDGE_TO_PROTECT_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_PLEDGE_TO_PROTECT_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_PLEDGE_TO_PROTECT_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BULLY_CITY_STATE_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BULLY_CITY_STATE_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BULLY_CITY_STATE_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BULLY_CITY_STATE_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BULLY_CITY_STATE_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BULLY_CITY_STATE_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BULLY_CITY_STATE_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BULLY_CITY_STATE_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BULLY_CITY_STATE_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BULLY_CITY_STATE_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DENOUNCE_MAJOR_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DENOUNCE_MAJOR_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DENOUNCE_MAJOR_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DENOUNCE_MAJOR_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DENOUNCE_MAJOR_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DENOUNCE_MAJOR_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DENOUNCE_MAJOR_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DENOUNCE_MAJOR_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DENOUNCE_MAJOR_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DENOUNCE_MAJOR_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DENOUNCE_MAJOR_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPREAD_RELIGION_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPREAD_RELIGION_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPREAD_RELIGION_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPREAD_RELIGION_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPREAD_RELIGION_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPREAD_RELIGION_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPREAD_RELIGION_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPREAD_RELIGION_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPREAD_RELIGION_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPREAD_RELIGION_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPREAD_RELIGION_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_TRADE_ROUTE_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_TRADE_ROUTE_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_TRADE_ROUTE_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_TRADE_ROUTE_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_TRADE_ROUTE_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_TRADE_ROUTE_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_TRADE_ROUTE_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_TRADE_ROUTE_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_TRADE_ROUTE_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_TRADE_ROUTE_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_TRADE_ROUTE_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WAR_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WAR_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WAR_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WAR_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WAR_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WAR_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WAR_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WAR_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WAR_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WAR_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WAR_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_STATE_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_STATE_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_STATE_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_STATE_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_STATE_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_STATE_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_STATE_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_STATE_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_STATE_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_FIND_CITY_STATE_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_LIBERATION_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_LIBERATION_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_LIBERATION_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_LIBERATION_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_LIBERATION_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_LIBERATION_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_LIBERATION_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_LIBERATION_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_LIBERATION_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_LIBERATION_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_LIBERATION_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_COUP_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_COUP_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_COUP_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_COUP_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_COUP_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_COUP_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_COUP_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_COUP_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_COUP_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_COUP_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CAMP_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CAMP_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CAMP_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CAMP_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CAMP_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CAMP_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CAMP_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CAMP_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CAMP_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CAMP_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CITY_STATE_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CITY_STATE_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CITY_STATE_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CITY_STATE_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CITY_STATE_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CITY_STATE_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CITY_STATE_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CITY_STATE_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CITY_STATE_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_KILL_CITY_STATE_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_CULTURE_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_CULTURE_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_CULTURE_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_CULTURE_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_CULTURE_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_CULTURE_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_CULTURE_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_CULTURE_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_CULTURE_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_CULTURE_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_CULTURE_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TECHS_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TECHS_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TECHS_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TECHS_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TECHS_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TECHS_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TECHS_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TECHS_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TECHS_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TECHS_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INVEST_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INVEST_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INVEST_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INVEST_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INVEST_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INVEST_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INVEST_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INVEST_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INVEST_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INVEST_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INFLUENCE_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INFLUENCE_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INFLUENCE_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INFLUENCE_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INFLUENCE_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INFLUENCE_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INFLUENCE_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INFLUENCE_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INFLUENCE_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_INFLUENCE_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TOURISM_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TOURISM_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TOURISM_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TOURISM_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TOURISM_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TOURISM_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TOURISM_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TOURISM_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TOURISM_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CONTEST_TOURISM_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CIRCUMNAVIGATION_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CIRCUMNAVIGATION_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CIRCUMNAVIGATION_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CIRCUMNAVIGATION_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CIRCUMNAVIGATION_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CIRCUMNAVIGATION_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CIRCUMNAVIGATION_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CIRCUMNAVIGATION_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CIRCUMNAVIGATION_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CIRCUMNAVIGATION_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_CIRCUMNAVIGATION_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_HORDE_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_HORDE_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_HORDE_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_HORDE_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_HORDE_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_HORDE_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_HORDE_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_HORDE_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_HORDE_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_HORDE_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_HORDE_COPIES_HYPERLINK); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_REBELLION_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_REBELLION_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_REBELLION_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_REBELLION_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_REBELLION_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_REBELLION_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_REBELLION_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_REBELLION_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_REBELLION_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_REBELLION_COPIES_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_REBELLION_COPIES_HYPERLINK); // VP
	...
	GD_INT_MEMBER(MAX_TURNS_OBSERVER_MODE);
	...
	GD_INT_MEMBER(OPINION_WEIGHT_MADE_DEMAND_YOU_NO_TAKE_DIVISOR); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_MADE_DEMAND_BANKRUPT_MULTIPLIER); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_MADE_DEMAND_BANKRUPT_MULTIPLIER_TURNS); // VP
	...
	GD_INT_MEMBER(OPINION_WEIGHT_FAILED_ASSIST_MAX); // VP
	...
	GD_INT_MEMBER(OPINION_WEIGHT_DP_CONQUEROR_MULTIPLIER); // VP
	...
	GD_INT_MEMBER(OPINION_WEIGHT_SAME_MASTER_DIFFERENT_SURRENDER_DIVISOR); // VP
	...
	GD_INT_MEMBER(CONQUEST_WAR_MULTIPLIER_TARGET_CAKEWALK); // VP
	...
	GD_INT_MEMBER(CONQUEST_WAR_MULTIPLIER_TARGET_DIFFICULT); // VP
	GD_INT_MEMBER(CONQUEST_WAR_MULTIPLIER_TARGET_BAD); // VP
	GD_INT_MEMBER(CONQUEST_WAR_MULTIPLIER_TARGET_IMPOSSIBLE); // VP
	GD_INT_MEMBER(MAJOR_WAR_MULTIPLIER_TARGET_CAKEWALK); // VP
	...
	GD_INT_MEMBER(MAJOR_WAR_MULTIPLIER_TARGET_DIFFICULT); // VP
	GD_INT_MEMBER(MAJOR_WAR_MULTIPLIER_TARGET_BAD); // VP
	GD_INT_MEMBER(MAJOR_WAR_MULTIPLIER_TARGET_IMPOSSIBLE); // VP
	GD_INT_MEMBER(MINOR_APPROACH_WAR_TARGET_CAKEWALK); // VP
	...
	GD_INT_MEMBER(MINOR_APPROACH_WAR_TARGET_DIFFICULT); // VP
	...
	GD_INT_MEMBER(APPROACH_RANDOM_PERSONALITIES_PERCENT); // VP
	...
	GD_INT_MEMBER(APPROACH_HOSTILE_BUYING_PRICE_MODIFIER); // VP
	GD_INT_MEMBER(APPROACH_GUARDED_BUYING_PRICE_MODIFIER); // VP
	GD_INT_MEMBER(APPROACH_AFRAID_BUYING_PRICE_MODIFIER); // VP
	GD_INT_MEMBER(APPROACH_NEUTRAL_BUYING_PRICE_MODIFIER); // VP
	GD_INT_MEMBER(APPROACH_FRIENDLY_BUYING_PRICE_MODIFIER); // VP
	GD_INT_MEMBER(APPROACH_HOSTILE_SELLING_PRICE_MODIFIER); // VP
	GD_INT_MEMBER(APPROACH_GUARDED_SELLING_PRICE_MODIFIER); // VP
	GD_INT_MEMBER(APPROACH_AFRAID_SELLING_PRICE_MODIFIER); // VP
	GD_INT_MEMBER(APPROACH_NEUTRAL_SELLING_PRICE_MODIFIER); // VP
	GD_INT_MEMBER(APPROACH_FRIENDLY_SELLING_PRICE_MODIFIER); // VP
	...
	GD_INT_MEMBER(THIRD_PARTY_PEACE_MIN_WAR_SCORE); // VP
	GD_INT_MEMBER(WAR_WEARINESS_MINIMUM_TURNS); // VP
	GD_INT_MEMBER(WAR_MAJOR_MINIMUM_TURNS); // VP
	GD_INT_MEMBER(WAR_MINOR_MINIMUM_TURNS); // VP
	GD_INT_MEMBER(WAR_MINOR_PEACE_BLOCKED_TURNS); // VP
	GD_INT_MEMBER(PLEDGE_BROKEN_MINIMUM_TURNS); // VP
	GD_INT_MEMBER(PLEDGE_BROKEN_MINIMUM_TURNS_BULLYING); // VP
	...
	GD_INT_MEMBER(MILITARY_RATING_PER_ADVANCED_START_ERA); // VP
	GD_INT_MEMBER(MILITARY_RATING_MAXIMUM_BONUS); // VP
	GD_INT_MEMBER(MILITARY_RATING_MAXIMUM_PENALTY); // VP
	GD_INT_MEMBER(MILITARY_RATING_HUMAN_BUFFER_VALUE_PERCENT); // VP
	...
	GD_INT_MEMBER(MILITARY_STRENGTH_REDUCTION_PER_BOLDNESS); // VP
	...
	GD_INT_MEMBER(MILITARY_STRENGTH_MINOR_BACKUP_IMMENSE); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MINOR_BACKUP_POWERFUL); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MINOR_BACKUP_STRONG); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MINOR_BACKUP_AVERAGE); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MINOR_BACKUP_POOR); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MINOR_BACKUP_WEAK); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MINOR_BACKUP_PATHETIC); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MINOR_BACKUP_NEIGHBORS); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MAJOR_BACKUP_IMMENSE); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MAJOR_BACKUP_POWERFUL); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MAJOR_BACKUP_STRONG); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MAJOR_BACKUP_AVERAGE); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MAJOR_BACKUP_POOR); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MAJOR_BACKUP_WEAK); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MAJOR_BACKUP_PATHETIC); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MAJOR_BACKUP_NEIGHBORS); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MAJOR_BACKUP_CLOSE); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MAJOR_BACKUP_FAR); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_MAJOR_BACKUP_DISTANT); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_BACKUP_ALREADY_WAR_EACH_PLAYER); // VP
	GD_INT_MEMBER(MILITARY_STRENGTH_BACKUP_ALREADY_WAR_MINIMUM); // VP
	...
	GD_INT_MEMBER(TARGET_ALREADY_WAR_MINIMUM); // VP
	GD_INT_MEMBER(TARGET_ECONOMIC_MOD); // VP
	GD_INT_MEMBER(TARGET_CITY_MOD); // VP
	GD_INT_MEMBER(TARGET_VALUE_RATIO_MULTIPLIER); // VP
	GD_INT_MEMBER(TARGET_VALUE_REDUCTION_PER_BOLDNESS); // VP
	GD_INT_MEMBER(TARGET_NEIGHBORS);
	GD_INT_MEMBER(TARGET_NEIGHBORS_DIVISOR); // VP
	GD_INT_MEMBER(TARGET_CLOSE);
	GD_INT_MEMBER(TARGET_CLOSE_DIVISOR); // VP
	GD_INT_MEMBER(TARGET_FAR);
	GD_INT_MEMBER(TARGET_FAR_DIVISOR); // VP
	GD_INT_MEMBER(TARGET_DISTANT);
	GD_INT_MEMBER(TARGET_DISTANT_DIVISOR); // VP
	GD_INT_MEMBER(TARGET_IMPOSSIBLE_THRESHOLD);
	GD_INT_MEMBER(TARGET_BAD_THRESHOLD);
	GD_INT_MEMBER(TARGET_DIFFICULT_THRESHOLD); // VP
	GD_INT_MEMBER(TARGET_AVERAGE_THRESHOLD);
	GD_INT_MEMBER(TARGET_FAVORABLE_THRESHOLD);
	GD_INT_MEMBER(TARGET_SOFT_THRESHOLD); // VP
	...
	GD_INT_MEMBER(WARMONGER_THREAT_MINOR_PREVIOUSLY_ATTACKED_WEIGHT); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_MAJOR_ATTACKED_WEIGHT);
	GD_INT_MEMBER(WARMONGER_THREAT_MAJOR_PREVIOUSLY_ATTACKED_WEIGHT); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_MAJOR_PURCHASED_CAPITAL_TILE_WEIGHT); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_MAJOR_PURCHASED_NONCAPITAL_TILE_WEIGHT); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_MAJOR_CULTURE_BOMBED_CAPITAL_TILE_WEIGHT); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_MAJOR_CULTURE_BOMBED_NONCAPITAL_TILE_WEIGHT); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_MAJOR_PREVIOUSLY_CULTURE_BOMBED_WEIGHT); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_MAJOR_CULTURE_BOMBED_CAPITAL_RADIUS); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_PLAYER_NUKED_WEIGHT); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_PLAYER_PREVIOUSLY_NUKED_WEIGHT); // VP
	...
	GD_INT_MEMBER(WARMONGER_THREAT_CASUS_BELLI_CULTURE_BOMBED); // VP
	...
	GD_INT_MEMBER(WARMONGER_THREAT_PER_TURN_DECAY_MINIMUM); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_CRITICAL_PERCENT_THRESHOLD);
	GD_INT_MEMBER(WARMONGER_THREAT_SEVERE_PERCENT_THRESHOLD);
	GD_INT_MEMBER(WARMONGER_THREAT_PER_TURN_DECAY_INCREASED_FRIENDS); // VP
	...
	GD_INT_MEMBER(DEMAND_LIMIT_MAX_VALUE); // VP
	GD_INT_MEMBER(DEMAND_LIMIT_GAMEPROGRESS_SCALING); // VP
	...
	GD_INT_MEMBER(AI_CITIZEN_VALUE_GOLD_IN_DEBT);
	GD_INT_MEMBER(AI_CITIZEN_SPECIALIST_COMBO_BONUS);
	GD_INT_MEMBER(AI_CITIZEN_UNHAPPINESS_VALUE_EMPIRE_VERY_UNHAPPY);
	GD_INT_MEMBER(AI_CITIZEN_UNHAPPINESS_VALUE_EMPIRE_UNHAPPY);
	GD_INT_MEMBER(AI_CITIZEN_UNHAPPINESS_VALUE_CITY_UNHAPPY);
	GD_INT_MEMBER(AI_CITIZEN_UNHAPPINESS_VALUE_EMPIRE_HAPPY);
	GD_INT_MEMBER(SUPER_UNHAPPY_THRESHOLD);
	GD_INT_MEMBER(LOCAL_HAPPINESS_FOOD_MODIFIER); // VP
	GD_INT_MEMBER(LOCAL_UNHAPPINESS_FOOD_MODIFIER); // VP
	GD_INT_MEMBER(LOCAL_UNHAPPY_SETTLER_PRODUCTION_PENALTY); // VP
	GD_INT_MEMBER(LOCAL_UNHAPPY_COMBAT_UNIT_PRODUCTION_PENALTY); // VP
	GD_INT_MEMBER(UNHAPPY_MAX_UNIT_PRODUCTION_PENALTY); // VP
	GD_INT_MEMBER(GREAT_MUSICIAN_BLAST_HAPPINESS_CAPITAL); // VP
	GD_INT_MEMBER(GREAT_MUSICIAN_BLAST_HAPPINESS_GLOBAL); // VP
	GD_INT_MEMBER(YIELD_MEDIAN_PERCENTILE); // VP
	GD_INT_MEMBER(YIELD_MEDIAN_MIN_POP_REQUIREMENT); // VP
	GD_INT_MEMBER(TECH_COUNT_MEDIAN_PERCENTILE); // VP
	GD_INT_MEMBER(DISTRESS_MEDIAN_BASE_MODIFIER); // VP
	GD_INT_MEMBER(POVERTY_MEDIAN_BASE_MODIFIER); // VP
	GD_INT_MEMBER(ILLITERACY_MEDIAN_BASE_MODIFIER); // VP
	GD_INT_MEMBER(BOREDOM_MEDIAN_BASE_MODIFIER); // VP
	GD_INT_MEMBER(CAPITAL_NEED_MODIFIER); // VP
	GD_INT_MEMBER(TECH_NEED_MODIFIER_PERCENT_RESEARCHED); // VP
	GD_INT_MEMBER(TECH_NEED_MODIFIER_PER_TECH_ABOVE_MEDIAN); // VP
	GD_INT_MEMBER(TECH_NEED_MODIFIER_PER_TECH_BELOW_MEDIAN); // VP
	...
	GD_INT_MEMBER(UNIT_SUPPLY_BASE_TECH_REDUCTION_PER_ERA); // VP
	GD_INT_MEMBER(UNIT_SUPPLY_CITIES_TECH_REDUCTION_MULTIPLIER); // VP
	GD_INT_MEMBER(UNIT_SUPPLY_POPULATION_TECH_REDUCTION_MULTIPLIER); // VP
	GD_INT_MEMBER(UNIT_SUPPLY_WAR_WEARINESS_PERCENT_REDUCTION); // VP
	GD_INT_MEMBER(PUPPET_YIELD_AND_SUPPLY_MODIFIER_MULTIPLICATIVE); // VP
	GD_INT_MEMBER(MINOR_CIV_UNIT_SUPPLY_MODIFIER_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_UNIT_SUPPLY_MODIFIER_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_UNIT_SUPPLY_MODIFIER_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_UNIT_SUPPLY_MODIFIER_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_UNIT_SUPPLY_MODIFIER_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_UNIT_SUPPLY_MODIFIER_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_UNIT_SUPPLY_MODIFIER_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_UNIT_SUPPLY_MODIFIER_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_UNIT_SUPPLY_MODIFIER_IRRATIONAL); // VP
	GD_INT_MEMBER(MINOR_CIV_UNIT_SUPPLY_MULTIPLIER_PER_EXTRA_CITY); // VP
	GD_INT_MEMBER(UNIT_COST_WAR_WEARINESS_PERCENT_INCREASE); // VP
	...
	GD_INT_MEMBER(BALANCE_BARBARIAN_HEAL_RATE); // VP
	GD_INT_MEMBER(BARBARIAN_CAMP_FIRST_TURN_PERCENT_OF_TARGET_TO_ADD);
	GD_INT_MEMBER(BARBARIAN_CAMP_FIRST_TURN_PERCENT_PER_ERA); // VP
	GD_INT_MEMBER(BARBARIAN_CAMP_MINIMUM_ISLAND_SIZE); // VP
	GD_INT_MEMBER(BARBARIAN_CAMP_MINIMUM_DISTANCE_CAPITAL);
	GD_INT_MEMBER(BARBARIAN_CAMP_MINIMUM_DISTANCE_ANOTHER_CAMP);
	GD_INT_MEMBER(BARBARIAN_CAMP_MINIMUM_DISTANCE_RECENTLY_CLEARED_CAMP); // VP
	GD_INT_MEMBER(BARBARIAN_CAMP_CLEARED_MIN_TURNS_TO_RESPAWN); // VP
	GD_INT_MEMBER(BARBARIAN_CAMP_COASTAL_SPAWN_ROLL);
	GD_INT_MEMBER(BARBARIAN_INITIAL_SPAWN_TURN); // VP
	GD_INT_MEMBER(BARBARIAN_CAMP_ODDS_OF_NEW_CAMP_SPAWNING);
	GD_INT_MEMBER(BARBARIAN_CAMP_SPAWN_RATE); // VP
	GD_INT_MEMBER(BARBARIAN_CAMP_SPAWN_RATE_RAGING); // VP
	GD_INT_MEMBER(BARBARIAN_CAMP_SPAWN_RATE_CHILL); // VP
	GD_INT_MEMBER(BARBARIAN_CAMP_NUM_AFTER_INITIAL); // VP
	GD_INT_MEMBER(BARBARIAN_CAMP_NUM_AFTER_INITIAL_CHILL); // VP
	GD_INT_MEMBER(BARBARIAN_CAMP_NUM_AFTER_INITIAL_RAGING); // VP
	GD_INT_MEMBER(BARBARIAN_INITIAL_SPAWN_TURN_FROM_SPAWNER); // VP
	GD_INT_MEMBER(BARBARIAN_NAVAL_UNIT_START_TURN_SPAWN);
	GD_INT_MEMBER(BARBARIAN_INITIAL_SPAWN_SPAWNER_DELAY); // VP
	GD_INT_MEMBER(BARBARIAN_MIN_SPAWN_DELAY); // VP
	GD_INT_MEMBER(BARBARIAN_SPAWN_DELAY_FROM_ENCAMPMENT); // VP
	GD_INT_MEMBER(BARBARIAN_SPAWN_DELAY_FROM_ENCAMPMENT_RAND); // VP
	GD_INT_MEMBER(BARBARIAN_SPAWN_DELAY_FROM_ENCAMPMENT_CHILL_MULTIPLIER); // VP
	GD_INT_MEMBER(BARBARIAN_SPAWN_DELAY_FROM_ENCAMPMENT_RAGING_MULTIPLIER); // VP
	GD_INT_MEMBER(BARBARIAN_ENCAMPMENT_SPAWN_DELAY_REDUCTION_PER_SPAWN); // VP
	GD_INT_MEMBER(BARBARIAN_ENCAMPMENT_MAX_SPAWN_DELAY_REDUCTION); // VP
	GD_INT_MEMBER(BARBARIAN_ENCAMPMENT_ATTACKED_DELAY_MULTIPLIER); // VP
	GD_INT_MEMBER(BARBARIAN_SPAWN_DELAY_FROM_CITY); // VP
	GD_INT_MEMBER(BARBARIAN_SPAWN_DELAY_FROM_CITY_RAND); // VP
	GD_INT_MEMBER(BARBARIAN_SPAWN_DELAY_FROM_CITY_CHILL_MULTIPLIER); // VP
	GD_INT_MEMBER(BARBARIAN_SPAWN_DELAY_FROM_CITY_RAGING_MULTIPLIER); // VP
	GD_INT_MEMBER(BARBARIAN_CITY_SPAWN_DELAY_REDUCTION_PER_SPAWN); // VP
	GD_INT_MEMBER(BARBARIAN_CITY_MAX_SPAWN_DELAY_REDUCTION); // VP
	GD_INT_MEMBER(BARBARIAN_CITY_ATTACKED_DELAY_MULTIPLIER); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_INITIAL_ENCAMPMENT_CREATION_SPAWN); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_INITIAL_ENCAMPMENT_CREATION_SPAWN_CHILL); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_INITIAL_ENCAMPMENT_CREATION_SPAWN_RAGING); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_INITIAL_ENCAMPMENT_CREATION_SPAWN_PER_ERA); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_ENCAMPMENT_CREATION_SPAWN); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_ENCAMPMENT_CREATION_SPAWN_CHILL); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_ENCAMPMENT_CREATION_SPAWN_RAGING); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_ENCAMPMENT_CREATION_SPAWN_PER_ERA); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_CITY_CAPTURE_SPAWN); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_CITY_CAPTURE_SPAWN_CHILL); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_CITY_CAPTURE_SPAWN_RAGING); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_CITY_CAPTURE_SPAWN_PER_ERA); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_PER_ENCAMPMENT_SPAWN); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_PER_ENCAMPMENT_SPAWN_CHILL); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_PER_ENCAMPMENT_SPAWN_RAGING); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_PER_ENCAMPMENT_SPAWN_PER_ERA); // VP
	GD_INT_MEMBER(MAX_BARBARIANS_FROM_CAMP_NEARBY);
	GD_INT_MEMBER(MAX_BARBARIANS_FROM_CAMP_NEARBY_RANGE);
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_PER_CITY_SPAWN); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_PER_CITY_SPAWN_CHILL); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_PER_CITY_SPAWN_RAGING); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_PER_CITY_SPAWN_PER_ERA); // VP
	GD_INT_MEMBER(MAX_BARBARIANS_FROM_CITY_NEARBY); // VP
	GD_INT_MEMBER(MAX_BARBARIANS_FROM_CITY_NEARBY_RANGE); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_PLUNDER_TRADE_ROUTE_SPAWN); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_PLUNDER_TRADE_ROUTE_SPAWN_CHILL); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_PLUNDER_TRADE_ROUTE_SPAWN_RAGING); // VP
	GD_INT_MEMBER(BARBARIAN_NUM_UNITS_PLUNDER_TRADE_ROUTE_SPAWN_PER_ERA); // VP
	GD_INT_MEMBER(BARBARIAN_UNIT_SPAWN_NUM_CANDIDATES); // VP
	GD_INT_MEMBER(BARBARIAN_UNIT_SPAWN_NO_RESOURCE_MULTIPLIER); // VP
	GD_INT_MEMBER(BARBARIAN_UNIT_SPAWN_UU_MULTIPLIER); // VP
	GD_INT_MEMBER(BARBARIAN_UNIT_SPAWN_PREFERRED_TYPE); // VP
	GD_INT_MEMBER(MINOR_QUEST_REBELLION_BARB_SPAWN_INTERVAL); // VP
	GD_INT_MEMBER(MINOR_QUEST_REBELLION_BARBS_PER_CS_UNIT); // VP
	GD_INT_MEMBER(MINOR_QUEST_REBELLION_BARBS_PER_ERA_BASE); // VP
	GD_INT_MEMBER(MINOR_QUEST_REBELLION_BARBS_PER_ERA_RAND); // VP
	GD_INT_MEMBER(MINOR_QUEST_REBELLION_BARBS_MIN); // VP
	GD_INT_MEMBER(MINOR_QUEST_ACQUIRE_CITY_BONUS_XP); // VP
	...
	GD_INT_MEMBER(IGNORE_GLOBAL_TERRAIN_COSTS_INCLUDES_RIVERS); // VP
	GD_INT_MEMBER(IGNORE_SPECIFIC_TERRAIN_COSTS_INCLUDES_RIVERS); // VP
	GD_INT_MEMBER(PEACE_DISENGAGEMENT_TURNS); // VP
	...
	GD_INT_MEMBER(MINOR_CIV_FIRST_CONTACT_NO_UNIT_CONSOLATION_MULTIPLIER); // VP
	...
	GD_INT_MEMBER(BALANCE_MARRIAGE_COST_BASE); // VP
	GD_INT_MEMBER(BALANCE_MARRIAGE_COST_INCREASE_PER_PREVIOUS_MARRIAGE); // VP
	...
	GD_INT_MEMBER(CITY_STRENGTH_LAND_UNIT_DIVISOR);
	GD_INT_MEMBER(CITY_STRENGTH_NAVAL_UNIT_DIVISOR);
	GD_INT_MEMBER(CITY_STRENGTH_HILL_CHANGE);
	GD_INT_MEMBER(CITY_STRENGTH_THRESHOLD_FOR_BONUSES); // VP
	...
	GD_INT_MEMBER(HISTORY_LOCAL_NUM_BEST_CITIES); // VP
	GD_INT_MEMBER(HISTORY_NUM_TURNS_TO_AVERAGE); // VP
	...
	GD_INT_MEMBER(BALANCE_FOLLOWER_FOOD_BONUS); // VP
	GD_INT_MEMBER(RELIGION_FOUND_AUTO_SPREAD_PRESSURE); // VP
	...
	GD_INT_MEMBER(BALANCE_GPP_RATE_IN_CAPITAL_PER_MARRIAGE); // VP
	GD_INT_MEMBER(BALANCE_MARRIAGE_RESTING_POINT_INCREASE); // VP
	GD_INT_MEMBER(BALANCE_SPY_RESPAWN_TIMER); // VP
	GD_INT_MEMBER(BALANCE_SPY_TO_PLAYER_RATIO); // VP
	GD_INT_MEMBER(BALANCE_SPY_POINT_THRESHOLD_MAX); // VP
	GD_INT_MEMBER(BALANCE_SPY_POINT_THRESHOLD_MIN); // VP
	GD_INT_MEMBER(BALANCE_SPY_POINT_MAJOR_PLAYER_MULTIPLIER); // VP
	...
	GD_INT_MEMBER(IDEOLOGY_UNLOCK_NUM_POLICY_BRANCHES_NEEDED); // VP
	GD_INT_MEMBER(IDEOLOGY_UNLOCK_NUM_POLICIES_NEEDED); // VP
	GD_INT_MEMBER(IDEOLOGY_UNLOCK_BASE_FREE_TENETS); // VP
	...
	GD_INT_MEMBER(BALANCE_WORLD_WONDER_EARLIER_ERA_COST_MODIFIER); // VP
	...
	GD_INT_MEMBER(BALANCE_PRODUCTION_DESERT_IMPROVEMENT); // VP
	...
	GD_INT_MEMBER(RELIGION_MAXIMUM_FIXED_AMOUNT); // VP
	GD_INT_MEMBER(RELIGION_MAXIMUM_PER_PLAYER_DIVISOR); // VP
	GD_INT_MEMBER(RELIGION_MAXIMUM_CAP); // VP
	...
	GD_INT_MEMBER(ESPIONAGE_CONSECUTIVE_RIGGING_INFLUENCE_MODIFIER); // VP
	GD_INT_MEMBER(ESPIONAGE_NP_BASE); // VP
	GD_INT_MEMBER(ESPIONAGE_NP_PER_SPY_RANK); // VP
	GD_INT_MEMBER(ESPIONAGE_NP_CULTURAL_INFLUENCE); // VP
	GD_INT_MEMBER(ESPIONAGE_NP_PER_TECHNOLOGY_BEHIND); // VP
	GD_INT_MEMBER(ESPIONAGE_NP_MAX_NUM_TECH); // VP
	GD_INT_MEMBER(ESPIONAGE_NP_REDUCTION_PER_SECURITY_POINT); // VP
	GD_INT_MEMBER(ESPIONAGE_MAX_NUM_SECURITY_POINTS); // VP
	GD_INT_MEMBER(ESPIONAGE_SECURITY_BASE); // VP
	GD_INT_MEMBER(ESPIONAGE_SECURITY_NOT_ALL_HAVE_SPIES); // VP
	GD_INT_MEMBER(ESPIONAGE_SECURITY_PREVIOUS_CITY_MISSIONS); // VP
	GD_INT_MEMBER(ESPIONAGE_SECURITY_PER_POPULATION); // VP
	GD_INT_MEMBER(ESPIONAGE_SECURITY_PER_POPULATION_BUILDING_SCALER); // VP
	GD_INT_MEMBER(ESPIONAGE_SECURITY_PER_TRADE_ROUTE); // VP
	GD_INT_MEMBER(ESPIONAGE_SECURITY_PER_EXCESS_UNHAPPINESS); // VP
	GD_INT_MEMBER(ESPIONAGE_SPY_EXPERIENCE_DENOMINATOR); // VP
	GD_INT_MEMBER(ESPIONAGE_XP_PER_TURN_COUNTERSPY); // VP
	GD_INT_MEMBER(ESPIONAGE_XP_PER_TURN_DIPLOMAT); // VP
	GD_INT_MEMBER(ESPIONAGE_XP_PER_TURN_OFFENSIVE); // VP
	GD_INT_MEMBER(ESPIONAGE_XP_PER_TURN_CITYSTATE); // VP
	GD_INT_MEMBER(ESPIONAGE_XP_RIGGING_SUCCESS); // VP
	...
	GD_INT_MEMBER(MINIMUM_TOURISM_MODIFIER); // VP
	...
	GD_INT_MEMBER(SHARE_APPROACH_TURN_BUFFER); // VP
	...
	GD_INT_MEMBER(VASSAL_PRESSURE_PERCENT); // VP
	...
	GD_INT_MEMBER(UNKNOWN_EXPLORE_TILE_VALUE);
	GD_INT_MEMBER(LAND_EXPLORE_TILE_VALUE);
	GD_INT_MEMBER(COAST_EXPLORE_TILE_VALUE);
	GD_INT_MEMBER(OCEAN_EXPLORE_TILE_VALUE);
	...
	GD_FLOAT_MEMBER(UNHAPPINESS_PER_OCCUPIED_POPULATION);
	GD_FLOAT_MEMBER(GLOBAL_GROWTH_PENALTY_PER_UNHAPPY); // VP
	GD_FLOAT_MEMBER(GLOBAL_SETTLER_PRODUCTION_PENALTY_PER_UNHAPPY); // VP
	GD_FLOAT_MEMBER(UNIT_UPGRADE_COST_MULTIPLIER_PER_ERA);
	GD_FLOAT_MEMBER(UNIT_UPGRADE_COST_EXPONENT);
	GD_FLOAT_MEMBER(UNIT_UPGRADE_COST_PER_PRODUCTION);
	GD_FLOAT_MEMBER(UNHAPPINESS_PER_RELIGIOUS_MINORITY_POP); // VP
	GD_FLOAT_MEMBER(UNHAPPINESS_PER_STARVING_POP); // VP
	GD_FLOAT_MEMBER(UNHAPPINESS_PER_PILLAGED_TILE); // VP
	GD_FLOAT_MEMBER(UNHAPPINESS_PER_ISOLATED_POP); // VP
	GD_FLOAT_MEMBER(BALANCE_CORP_OFFICE_FRANCHISE_CONVERSION); // VP
	GD_FLOAT_MEMBER(BALANCE_CORP_OFFICE_TR_CONVERSION); // VP
	GD_FLOAT_MEMBER(DIPLO_VICTORY_CIV_DELEGATES_ALIVE); // VP
	GD_FLOAT_MEMBER(DIPLO_VICTORY_CIV_DELEGATES_ELIMINATED); // VP
	GD_FLOAT_MEMBER(DIPLO_VICTORY_CS_DELEGATES_ALIVE); // VP
	GD_FLOAT_MEMBER(DIPLO_VICTORY_CS_DELEGATES_ELIMINATED); // VP
	...
	GD_INT_MEMBER(GANDHI_LEADER); // VP
	GD_INT_MEMBER(NUKE_TRIGGER_PROJECT); // VP
	...
	GD_INT_MEMBER(MARCH_PROMOTION); // VP
...
protected:
	...
	************************************************************************************************************************/
	...
	CvSpyPassiveBonusXMLEntries* m_pSpyPassiveBonuses;
	CvSpyPassiveBonusDiplomatXMLEntries* m_pSpyPassiveBonusesDiplomat;
