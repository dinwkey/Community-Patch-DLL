...
enum CLOSED_ENUM DiploStatementTypes
{
	...
	DIPLO_STATEMENT_PLUNDERED_TRADE_ROUTE,
	...
	DIPLO_STATEMENT_INSULT_THROTTLE,
	DIPLO_STATEMENT_TAUNT_THROTTLE,
	...
	NUM_DIPLO_STATEMENT_TYPES ENUM_META_VALUE,
};
...
enum CLOSED_ENUM DiploMessageTypes
{
	...
	DIPLO_MESSAGE_HUMAN_DEMAND_REFUSE_PROTECTED_BY_MASTER,
	...
	// Trade plundering messages
	DIPLO_MESSAGE_PLUNDERED_TRADE_ROUTE,
	DIPLO_MESSAGE_STOP_PLUNDERING_YES,
	DIPLO_MESSAGE_STOP_PLUNDERING_NO,
	DIPLO_MESSAGE_STOP_PLUNDERING_AGREE, // the AI's response when the player asks to stop plundering trade routes
	DIPLO_MESSAGE_STOP_PLUNDERING_DISAGREE, // the AI's response when the player asks to stop plundering trade routes
	...
	// Putmalk -----------------------
	DIPLO_MESSAGE_HOSTILE_REPEAT_SHARE_APPROACH_NO,
	DIPLO_MESSAGE_REPEAT_SHARE_APPROACH_NO,
	DIPLO_MESSAGE_HOSTILE_SHARE_APPROACH_NO,
	DIPLO_MESSAGE_SHARE_APPROACH_NO,
	DIPLO_MESSAGE_SHARE_APPROACH_FRIENDLY,
	DIPLO_MESSAGE_SHARE_APPROACH_NEUTRAL,
	DIPLO_MESSAGE_SHARE_APPROACH_GUARDED,
	DIPLO_MESSAGE_SHARE_APPROACH_HOSTILE,
	DIPLO_MESSAGE_SHARE_APPROACH_AFRAID,
	DIPLO_MESSAGE_SHARE_APPROACH_WAR,
	DIPLO_MESSAGE_SHARE_APPROACH_PLANNING_WAR,
	DIPLO_MESSAGE_SHARE_APPROACH_DECEPTIVE,
	...
	DIPLO_MESSAGE_TOO_SOON_FOR_SHARE_APPROACH,
	...
	DIPLO_MESSAGE_VASSALAGE_BECOME_VASSAL,
	// -----------------------
...
enum CLOSED_ENUM UnhappyReasons
{
	...
	UNHAPPY_REASON_BUILDINGS,
};

enum CLOSED_ENUM BarbSpawnReason
{
	BARB_SPAWN_NEW_ENCAMPMENT,
	BARB_SPAWN_FROM_ENCAMPMENT,
	BARB_SPAWN_FROM_CITY,
	BARB_SPAWN_CITY_CAPTURE,
	BARB_SPAWN_PLUNDERED_TRADE_ROUTE,
	BARB_SPAWN_PARTISANS,
	BARB_SPAWN_UPRISING,
	BARB_SPAWN_HORDE_QUEST,
	BARB_SPAWN_CITY_STATE_CAPTURE,
	BARB_SPAWN_EVENT,
};
...
// --------------
// Putmalk
#define GAMEOPTION_DISABLE_RESEARCH_AGREEMENTS	"GAMEOPTION_DISABLE_RESEARCH_AGREEMENTS"
#define GAMEOPTION_ENABLE_TECH_TRADING		"GAMEOPTION_ENABLE_TECH_TRADING"
#define GAMEOPTION_ENABLE_VASSALAGE			"GAMEOPTION_ENABLE_VASSALAGE"
#define GAMEOPTION_NO_VOLUNTARY_VASSALAGE	"GAMEOPTION_NO_VOLUNTARY_VASSALAGE"
#define GAMEOPTION_NO_TECH_BROKERING	"GAMEOPTION_NO_TECH_BROKERING"
#define GAMEOPTION_TRANSPARENT_DIPLOMACY	"GAMEOPTION_TRANSPARENT_DIPLOMACY"
// ---------------
#define GAMEOPTION_PASSIVE_ESPIONAGE	"GAMEOPTION_PASSIVE_ESPIONAGE"
#define GAMEOPTION_DISABLE_AI_VICTORY_COMPETITION	"GAMEOPTION_DISABLE_AI_VICTORY_COMPETITION"
#define GAMEOPTION_DISABLE_AI_ENDGAME_AGGRESSION	"GAMEOPTION_DISABLE_AI_ENDGAME_AGGRESSION"
...
#define GAMEOPTION_TRADE_EVENTS			"GAMEOPTION_TRADE_EVENTS"
#define GAMEOPTION_CIV_SPECIFIC_EVENTS	"GAMEOPTION_CIV_SPECIFIC_EVENTS"
#define GAMEOPTION_CHILL_BARBARIANS			"GAMEOPTION_CHILL_BARBARIANS"
#define GAMEOPTION_RANDOMIZED_VICTORIES			"GAMEOPTION_RANDOMIZED_VICTORIES"
#define GAMEOPTION_RANDOMIZE_CITY_NAMES			"GAMEOPTION_RANDOMIZE_CITY_NAMES"
...
enum CLOSED_ENUM TaskTypes
{
	...
	TASK_UNSLOT_SPECIALIST, // remove a specialist and assign it to a plot
	TASK_RESET_SPECIALISTS, // reset specialists
...
enum CLOSED_ENUM UnitAITypes
{
	...
	UNITAI_DIPLOMAT,				// great diplomat
	UNITAI_MESSENGER,				// non-great diplomatic unit
	// New UNITAI for MOD_AI_UNIT_PRODUCTION
	UNITAI_SKIRMISHER,
	UNITAI_SUBMARINE,
...
enum CLOSED_ENUM ActivityTypes
{
	...
	ACTIVITY_AWAKE,
	ACTIVITY_HOLD,		//skip
	ACTIVITY_SLEEP,		//fortify
	ACTIVITY_HEAL,		//guess!
	ACTIVITY_SENTRY,	//alert
	ACTIVITY_INTERCEPT,
	ACTIVITY_MISSION,
...
enum CLOSED_ENUM ControlTypes
{
	...
	CONTROL_TOGGLE_OBSERVER_MODE,
	CONTROL_TOGGLE_AI_TAKEOVER,
	CONTROL_SWITCH_TO_NEXT_PLAYER,
	CONTROL_HUMAN_AI_PATH,
...
enum CLOSED_ENUM AITacticalMove
{
	...
	AI_TACTICAL_UNASSIGNED,
	AI_TACTICAL_GUARD,
	AI_TACTICAL_GARRISON,
	AI_TACTICAL_OPERATION,
	...
	AI_TACTICAL_HEAL,
	AI_TACTICAL_SAFETY,
	AI_TACTICAL_REPOSITION,
	AI_TACTICAL_ESCORT,

	AI_TACTICAL_AIRSWEEP,
	AI_TACTICAL_AIRPATROL,

	AI_TACTICAL_HEDGEHOG,
	AI_TACTICAL_COUNTERATTACK,
	AI_TACTICAL_WITHDRAW,
	AI_TACTICAL_REINFORCE,
	AI_TACTICAL_ATTRITION,
	AI_TACTICAL_SURGICAL_STRIKE,
	AI_TACTICAL_STEAMROLL,
	AI_TACTICAL_FLANKATTACK,

	AI_TACTICAL_AIRLIFT,
	AI_TACTICAL_BLOCKADE,
	AI_TACTICAL_CAPTURE,

	AI_TACTICAL_BARBARIAN_CAMP,
...
enum CLOSED_ENUM AIHomelandMove
{
	...
	AI_HOMELAND_MOVE_OPPORTUNITY_ATTACK,
...
enum CLOSED_ENUM DiploUIStateTypes
{
	...
	DIPLO_UI_STATE_PLUNDERED_TRADE_ROUTE,
...
enum CLOSED_ENUM FromUIDiploEventTypes
{
	...
	FROM_UI_DIPLO_EVENT_HUMAN_DISCUSSION_STOP_PLUNDERING,
	FROM_UI_DIPLO_EVENT_PLUNDERED_TRADE_ROUTE_RESPONSE,
	...
	FROM_UI_DIPLO_EVENT_HUMAN_DISCUSSION_SHARE_APPROACH,
...
enum CLOSED_ENUM InstantYieldType
{
	...
	INSTANT_YIELD_TYPE_RESEARCH_AGREEMENT		= 44,
	...
	INSTANT_YIELD_TYPE_HEALING					= 62,
	INSTANT_YIELD_TYPE_SCRAP_OR_UPGRADE			= 63,
...
enum CLOSED_ENUM UnhappinessType
{
	...
	UNHAPPINESS_TYPE_SPECIALIST = 1,
	UNHAPPINESS_TYPE_STARVING = 2,
	UNHAPPINESS_TYPE_PILLAGED = 3,
	UNHAPPINESS_TYPE_DISTRESS = 4,
	UNHAPPINESS_TYPE_POVERTY = 5,
	UNHAPPINESS_TYPE_CONNECTION = 6,
	UNHAPPINESS_TYPE_RELIGION = 7,
...
enum CLOSED_ENUM AccomplishmentTypes
{
	...
	ACCOMPLISHMENT_WARS_WON = 21,
	ACCOMPLISHMENT_CITY_CONVERTED = 22,
	ACCOMPLISHMENT_HISTORIC_EVENT = 23,

	NUM_ACCOMPLISHMENTS_TYPES ENUM_META_VALUE
};

enum CLOSED_ENUM HistoricEventTypes
{
	HISTORIC_EVENT_ERA_CHANGE = 0,
	...
	HISTORIC_EVENT_RELIGION_SPREAD = 9,
	// The entries below are only used for CvPlayer::DoDifficultyBonus().
	DIFFICULTY_BONUS_CITY_FOUND_CAPITAL = 10,
	DIFFICULTY_BONUS_CITY_FOUND = 11,
	DIFFICULTY_BONUS_CITY_CONQUEST = 12,
	DIFFICULTY_BONUS_RESEARCHED_TECH = 13,
	DIFFICULTY_BONUS_ADOPTED_POLICY = 14,
	DIFFICULTY_BONUS_COMPLETED_POLICY_TREE = 15,
	DIFFICULTY_BONUS_KILLED_MAJOR_UNIT = 16,
	DIFFICULTY_BONUS_KILLED_CITY_STATE_UNIT = 17,
	DIFFICULTY_BONUS_KILLED_BARBARIAN_UNIT = 18,
	DIFFICULTY_BONUS_PLAYER_TURNS_PASSED = 19,
	DIFFICULTY_BONUS_AI_TURNS_PASSED = 20,
...
enum CLOSED_ENUM RoutePurpose
{
	...
	PURPOSE_CONNECT_CAPITAL = 1,
	PURPOSE_SHORTCUT = 2,
	PURPOSE_STRATEGIC = 4,
	PURPOSE_MANUAL = 8
};

enum CLOSED_ENUM RoutePlanTypes
{
	NO_PLANNED_ROUTE = -1,

	ROAD_PLANNING_EXCLUDE,
	ROAD_PLANNING_INCLUDE,
	ROAD_PLANNING_PRIORITY_CONSTRUCTION
};

enum CLOSED_ENUM Likelyhood
{
	LIKELYHOOD_IMPOSSIBLE = 0,
	LIKELYHOOD_UNLIKELY,
	LIKELYHOOD_POSSIBLE,
	LIKELYHOOD_LIKELY,
	LIKELYHOOD_CERTAIN
